...
export const getReportEvaluationMethods = (
  ...
  const allMethods = [...fixedMethods, ...assessmentNames];
  return allMethods.map(
    (method) =>
      new Paragraph({
        alignment: "left",
        children: [
